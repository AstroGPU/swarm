 ...
 *    \brief Program for computing change in energy during integration
 * from binary files generated by swarm GPU logging subsystem.
 *
 * @authors Mario Juric
 *
 * swarm_test_energy is a useful tool for checking that an ensemble of integrations conserved enegy to an acceptible level.
 * usage: swarm_test_energy datafile
 * 
 * Example:
 * Assuming that you have already generated a binary output file from the
 * swarm loggin system that is named log.bin, you would run: +
 * ../bin/swarm_test_energy log.bin 
 *
*/
