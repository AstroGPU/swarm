...
//
	template<typename L, int N>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N])
	{
		log.write(gpulog::MSG_PRINTF, fmt);
	}
	template<typename L, int N, typename T1>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1)
	{
		log.write(gpulog::MSG_PRINTF, fmt, f2d(T1, v1));
	}
	template<typename L, int N, typename T1, typename T2>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4, typename T5>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8)
	{
	...
	template<typename L, int N, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
		__host__ __device__ inline void lprintf(L &log, const char (&fmt)[N], const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9)
	{
