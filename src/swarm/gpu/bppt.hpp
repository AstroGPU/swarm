...
#if 0
  // This has been moved to Gravitation, since it is about how gravitation stores things in memory, rather than the integrator.  
  // Also, that way it can know which WARPSIZE to use
	template< class T> 
