...
EXEOBJECTS = src/swarm.o src/swarm_test_hermite_cpu.o
ALLOBJECTS = $(OBJECTS) $(EXEOBJECTS)

all: bin/swarm bin/swarm_test_hermite_cpu
...
clean:
	rm -f $(ALLOBJECTS) *.linkinfo src/swarm.cu bin/swarm integrators/*/*.o bin/swarm_test_hermite_cpu
