...
###
DOC_INPUT=docs/README.txt docs/build_system.txt docs/configuration_file.txt docs/for_developers.txt 	docs/performance.txt # asciidoc general documentation
